...
关闭。即使未来补齐 MAT 许可，P6/P9 的真实认证 provider、formal runtime、一次性 claim 和
完整产物复验仍是互相独立的正式门禁。
...
因 MAT 来源链未核实而关闭。即使补齐许可，这批产物的 evaluator 仍明确保存
...
严格微小超限及 certified enclosure 传播。P8 已完成双轴审查和独立提交；当前实施入口
已经越过第 17 节 P9。
...
缺失继续为 ``to_verify``。因此当前 preflight 首先被 MAT 许可门禁阻塞；补齐该门禁后还须
