...
状态：**P1-P9 已完成独立提交；当前进入 P10 冻结 CSTR 端到端评价**
...
当前实施入口直接推进到第 18 节 P10。P10 在读取一次性真实故障评价前，必须先核实 CSTR
许可、冻结 manifest、checkpoint、数据/分区/窗口/episode 身份和全部 P1--P9 配置；不得
用当前 smoke、线性特例或正常校准结果填充论文性能数值。
