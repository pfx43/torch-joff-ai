...
- 实验对象：闭环 CSTR（preset `cstr_closed_loop_fd`，u=(Ci,Ti,Tci)，y=(C,T,Tc,Qc)，fault01–08、onset=200，故障 1–2 过程 / 3–5 执行器 / 6–8 传感器）。P1 已实现逐行 onset 标签、u/y schema、episode 与来源 hash 追溯；许可仍为 to_verify。
